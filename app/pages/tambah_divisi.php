            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-white active" aria-current="page">Tambah Divisi</li>
                    </ol>
                    <h6 class="font-weight-bolder text-white mb-0">Tambah Divisi</h6>
                </nav>
            ...
            <div class="row">
                ...
                <div class="card mt-4">
                    ...
                    <div class="card-body p-3">
                        <hr class="horizontal dark mt-0">
                        <form role="form" action="action/divisi.php?act=tambah" method="POST">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg" placeholder="Nama Divisi"
                                    aria-label="Email" name="nama_divisi" required>
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control form-control-lg" placeholder="Gaji Divisi"
                                    aria-label="Email" name="gaji_divisi" required>
                            </div>
                            <div class="text-center">
                                <button type="submit"
                                    class="btn btn-lg btn-primary btn-lg w-100 mt-4 mb-0">Tambah</button>
                            </div>
                        </form>
                    </div>
                </div>
