      ...
      <div class="page-header min-vh-100">
        <div class="container">
          ...
          background-size: cover;">
                ...
                <h4 class="mt-5 text-white font-weight-bolder position-relative">"Jangan biarkan perasaan putus asa menyerang dirimu. Yakinlah, pada akhirnya, kamu pasti akan berhasil."</h4>
                <p class="text-white position-relative">Abraham Lincoln</p>
              </div>
            </div>
          </div>
        </div>
